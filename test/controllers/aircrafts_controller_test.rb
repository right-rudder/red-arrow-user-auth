...
class AircraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aircraft" do
    assert_difference("Aircraft.count") do
      post aircrafts_url, params: { aircraft: { model: @aircraft.model, name: @aircraft.name, status: @aircraft.status, string: @aircraft.string, tail_number: @aircraft.tail_number } }
    end
  ...
  test "should update aircraft" do
    patch aircraft_url(@aircraft), params: { aircraft: { model: @aircraft.model, name: @aircraft.name, status: @aircraft.status, string: @aircraft.string, tail_number: @aircraft.tail_number } }
