...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference("Instructor.count") do
      post instructors_url, params: { instructor: { bio: @instructor.bio, license_expiration: @instructor.license_expiration, license_name: @instructor.license_name, photo: @instructor.photo, user_id: @instructor.user_id } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { bio: @instructor.bio, license_expiration: @instructor.license_expiration, license_name: @instructor.license_name, photo: @instructor.photo, user_id: @instructor.user_id } }
